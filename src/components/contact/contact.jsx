...
class Contact extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    let API_KEY = "mlnvPBOIPxuS6YFbg";

    // YOUR EMAIL.JS TEMPLATE ID
    let TEMPLATE_ID = "template_svp2ngi";
    ...
    return (
      <div id="contact">
        ...
        <div className="wrapper">
          ...
          <div className="box" >
      <h1 className=" weight800 font60 padding40">CONTACT US</h1>
      <h1 className=" weight800 font60 padding40">CONTACT US</h1>
    </div>
          <p className="font19">
          Your Brand's Journey is Unique, and We're Here to Personalize It.
          <br />
          Start a Conversation with Us and Let's Craft Your Story Together.
          </p>
